...
# Init
$(call soong_config_set,libinit,vendor_init_lib,//$(LOCAL_PATH):init_xiaomi_sm6150)
...
ifeq ($(TARGET_USES_DOLBY),true)
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/media/media_codecs_c2_dolby.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml
else
PRODUCT_COPY_FILES += \
